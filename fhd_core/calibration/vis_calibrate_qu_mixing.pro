PRO vis_calibrate_qu_mixing,vis_ptr,vis_model_ptr,flag_ptr,obs,cal
...
pseudo_Q = Total(Temporary(pseudo_Q)*flag_use,3)
...
pseudo_U_model = Total(Temporary(pseudo_U_model)*flag_use,3)
